    ...
    <div className="container-fluid d-flex flex-column align-items-center">
      <div className="row header-container">
        <div className="header col-md-7 ms-4 ps-4">
          ...
          <p className="fs-5">
            ...
            ratione itaque reiciendis perferendis deserunt fugiat ad! Fuga iure odio voluptatum
            fugit sed aliquid sequi voluptas adipisci omnis.
          </p>
        </div>
      </div>
      <div className="squares row gap-3 d-flex justify-content-center">
        <div className="square col-lg-3 m-2 border rounded">
          <h5>Duración</h5>
          <p>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quod, aspernatur consectetur.
            Voluptatibus ipsum aut autem necessitatibus amet quae delectus. Consequuntur officiis
            voluptatem adipisci eligendi doloremque earum reiciendis dolores quas impedit?
          </p>
        </div>
        <div className="square col-lg-3 m-2 border rounded">
          <h5>Tecnologías</h5>
          <p>
            ...
            similique aspernatur corrupti sit recusandae, voluptatibus illo modi omnis beatae harum!
            Cumque, culpa et molestiae accusamus consectetur dolorem!
          </p>
        </div>
        <div className="square col-lg-3 m-2 border rounded">
