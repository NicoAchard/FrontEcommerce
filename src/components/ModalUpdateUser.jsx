            ...
            <div className="d-flex gap-3">
              <Form.Group className="mb-3 w-100" controlId="ControlInput2">
                ...
                <Form.Control
                  ...
                  className={`${
                    responseUpdateUser
                      ? !inputFirstname.trim() && responseUpdateUser.status === 401 && "is-invalid"
                      : ""
                  }`}
                  required
                />
              ...
              <Form.Group className="mb-3 w-100" controlId="ControlInput3">
                ...
                <Form.Control
                  ...
                  className={`${
                    responseUpdateUser
                      ? !inputLastname.trim() && responseUpdateUser.status === 401 && "is-invalid"
                      : ""
                  }`}
                  required
                />
            ...
            <div className="d-flex gap-3">
              ...
              <Form.Group className="mb-3 w-100" controlId="ControlInput5">
                ...
                <Form.Control
                  ...
                  className={`${
                    responseUpdateUser
                      ? !inputAddress.trim() && responseUpdateUser.status === 401 && "is-invalid"
                      : ""
                  }`}
                  required
                />
